...
namespace Explorer.API.Controllers.Tourist
{
    ...
    [Route("api/tourism/equipmentForTourist")]
    public class EquipmentForTouristController : BaseApiController
    {
        private readonly IEquipmentService _equipmentService;

        public EquipmentForTouristController(IEquipmentService equipmentService)
        {
        ...
        //[HttpGet]
        //public ActionResult<PagedResult<EquipmentDto>> GetById([FromQuery] int page, [FromQuery] int pageSize)
        //{
        //    var result = _equipmentService.GetById(page, pageSize);
        //    return CreateResponse(result);
        //}
