...
namespace Explorer.Encounters.Tests.Integration
{
    ...
    public class SocialEncounterExecutionTests : BaseEncountersIntegrationTest
    {
        public SocialEncounterExecutionTests(EncountersTestFactory factory) : base(factory) { }
        ...
        public static IEnumerable<object[]> CreatesData()
        {
            ...
            {
                new object[] { notWithin50Meters, -2, 400m, "-21" },
                new object[] { within50Meters, -2, 200, "-23" },
